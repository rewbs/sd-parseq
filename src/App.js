...
import {Tooltip as Tooltip2} from '@mui/material/Tooltip';
...
const [columnDefs, setColumnDefs] = useState([
    ...
    ...interpolatableFields.flatMap(interpolationColumn)
...
const render = useCallback((event) => {
  ...
  var rendered_frames = [];
  var all_frame_numbers = getAllFrames(gridRef);
...
const [displayFields, setDisplayFields] = React.useState(['denoise', 'rotx']);
const [visFields, setVisFields] = React.useState(['denoise']);
...
<CssBaseline />  
  ...
  <LineChart width={800} height={300} data={rawData.rendered_frames}>
